...
var init = async ( space ) => {
  ...
  bit = await space.hunt(ActMap.SHAPE_HEXMAP, { idx, dat: { frm: SHAPE.RECTANGLE, h: 44, w: 5 } })
  ...
  bit = await space.hunt(ActFoc.WRITE_FOCUS, { idx: 'foc01', src:'map00', dat: { typ: FOCUS.AVAS } })
  var avas = bit.focBit.dat

  bit = await space.hunt(ActFoc.FORWARD_FOCUS, { idx: 'foc01' })
  var avas = bit.focBit.dat
  ...
  bit = await space.hunt(ActFoc.SPIN_LEFT_FOCUS, { idx: 'foc01' })
  var avas = bit.focBit.dat
